...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/tmap_ui_sdk/tmap_ui_sdk.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TmapNaviSDK/TmapNaviSDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TmapUISDK/TmapUISDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/VSMSDK/VSMSDK.framework"
fi
