...
struct GasStationInfo FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef GasStationInfoBuilder Builder;
  ...
  /// 주유소 좌표
  const vsm::route::LonLat *lonLat() const {
    return GetStruct<const vsm::route::LonLat *>(VT_LONLAT);
  }
  /// vertex index
  int32_t vertexIndex() const {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_BRAND, 1) &&
           VerifyField<uint8_t>(verifier, VT_FACILITY, 1) &&
           VerifyField<uint8_t>(verifier, VT_ROADCODE, 1) &&
           VerifyField<uint8_t>(verifier, VT_HASPREMIUMOIL, 1) &&
           VerifyField<uint8_t>(verifier, VT_ISLOWERPRICE, 1) &&
           VerifyField<vsm::route::LonLat>(verifier, VT_LONLAT, 8) &&
           VerifyField<int32_t>(verifier, VT_VERTEXINDEX, 4) &&
           VerifyOffset(verifier, VT_NAME) &&
           verifier.VerifyVector(name()) &&
           VerifyField<uint16_t>(verifier, VT_GASOLINEPRICE, 2) &&
           VerifyField<uint16_t>(verifier, VT_DIESELPRICE, 2) &&
           VerifyField<uint16_t>(verifier, VT_KEROSENEPRICE, 2) &&
           VerifyField<uint16_t>(verifier, VT_LPGPRICE, 2) &&
           VerifyField<uint16_t>(verifier, VT_PREMIUMGASOLINEPRICE, 2) &&
           VerifyField<uint16_t>(verifier, VT_PREMIUMDIESELPRICE, 2) &&
           VerifyField<uint16_t>(verifier, VT_PREMIUMKEROSENEPRICE, 2) &&
           VerifyField<uint32_t>(verifier, VT_DISTANCE, 4) &&
           VerifyField<uint32_t>(verifier, VT_POIID, 4) &&
           VerifyField<uint32_t>(verifier, VT_ISPARTNERCARDSALE, 4) &&
           verifier.EndTable();
  }
};

struct GasStationInfoBuilder {
  typedef GasStationInfo Table;
  ...
  void add_lonLat(const vsm::route::LonLat *lonLat) {
...
inline ::flatbuffers::Offset<GasStationInfo> CreateGasStationInfo(
    ...
    const vsm::route::LonLat *lonLat = nullptr,
...
struct AccidentInfo FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AccidentInfoBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_VERTEXINDEX = 4,
    VT_CODE = 6,
    VT_DESCRIPTION = 8
...
struct EVStationInfo FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EVStationInfoBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_VERTEXINDEX = 4,
    VT_POIID = 6,
    VT_ROADCODE = 8,
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_VERTEXINDEX, 4) &&
           VerifyField<int32_t>(verifier, VT_POIID, 4) &&
           VerifyField<uint8_t>(verifier, VT_ROADCODE, 1) &&
           VerifyField<vsm::route::LonLat>(verifier, VT_LONLAT, 8) &&
           VerifyField<uint8_t>(verifier, VT_ONROUTE, 1) &&
           VerifyField<uint8_t>(verifier, VT_DCCHA, 1) &&
           VerifyField<uint8_t>(verifier, VT_AC3, 1) &&
           VerifyField<uint8_t>(verifier, VT_DCCOMBO, 1) &&
           VerifyField<uint8_t>(verifier, VT_SLOWCHARGE, 1) &&
           VerifyField<uint8_t>(verifier, VT_SUPERCHARGE, 1) &&
           VerifyOffset(verifier, VT_NAME) &&
           verifier.VerifyVector(name()) &&
           verifier.EndTable();
  }
...
struct RouteData FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef RouteDataBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_LINKLIST = 4,
  ...
  const ::flatbuffers::Vector<const vsm::route::LinkInfo *> *linkList() const {
    return GetPointer<const ::flatbuffers::Vector<const vsm::route::LinkInfo *> *>(VT_LINKLIST);
  }
  const ::flatbuffers::Vector<const vsm::route::RGServiceLink *> *rgServiceLinkList() const {
    return GetPointer<const ::flatbuffers::Vector<const vsm::route::RGServiceLink *> *>(VT_RGSERVICELINKLIST);
  }
  const ::flatbuffers::Vector<const vsm::route::LonLat *> *vertexList() const {
    return GetPointer<const ::flatbuffers::Vector<const vsm::route::LonLat *> *>(VT_VERTEXLIST);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::GasStationInfo>> *gasStationList() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::GasStationInfo>> *>(VT_GASSTATIONLIST);
  }
  /// 경로 타입 1:주행경로, 2:대안경로
  ...
  /// 주요경로 출력
  const ::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::PositionInfo>> *mainRoadList() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::PositionInfo>> *>(VT_MAINROADLIST);
  }
  /// 좌표 정보 (0:출발지, 1:경유지1, 2:경유지2, ..., n:목적지)
  const ::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::PositionInfo>> *positionList() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::PositionInfo>> *>(VT_POSITIONLIST);
  }
  /// 유고정보
  const ::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::AccidentInfo>> *accidentInfoList() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::AccidentInfo>> *>(VT_ACCIDENTINFOLIST);
  }
  /// 전기차 충전소 정보
  const ::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::EVStationInfo>> *evStationList() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::EVStationInfo>> *>(VT_EVSTATIONLIST);
  }
  /// 목적지 건너편 지점 (0: 미사용)
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_ROUTETYPE, 1) &&
           VerifyField<int32_t>(verifier, VT_TVASID, 4) &&
           ...
           VerifyField<int32_t>(verifier, VT_OPPOSITESIDEVERTEXINDEX, 4) &&
           verifier.EndTable();
  }
};

struct RouteDataBuilder {
  typedef RouteData Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_linkList(::flatbuffers::Offset<::flatbuffers::Vector<const vsm::route::LinkInfo *>> linkList) {
    fbb_.AddOffset(RouteData::VT_LINKLIST, linkList);
  }
  void add_rgServiceLinkList(::flatbuffers::Offset<::flatbuffers::Vector<const vsm::route::RGServiceLink *>> rgServiceLinkList) {
    fbb_.AddOffset(RouteData::VT_RGSERVICELINKLIST, rgServiceLinkList);
  }
  void add_vertexList(::flatbuffers::Offset<::flatbuffers::Vector<const vsm::route::LonLat *>> vertexList) {
    fbb_.AddOffset(RouteData::VT_VERTEXLIST, vertexList);
  }
  void add_gasStationList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::GasStationInfo>>> gasStationList) {
  ...
  void add_mainRoadList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::PositionInfo>>> mainRoadList) {
    fbb_.AddOffset(RouteData::VT_MAINROADLIST, mainRoadList);
  }
  void add_positionList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::PositionInfo>>> positionList) {
    fbb_.AddOffset(RouteData::VT_POSITIONLIST, positionList);
  }
  void add_accidentInfoList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::AccidentInfo>>> accidentInfoList) {
    fbb_.AddOffset(RouteData::VT_ACCIDENTINFOLIST, accidentInfoList);
  }
  void add_evStationList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::EVStationInfo>>> evStationList) {
...
inline ::flatbuffers::Offset<RouteData> CreateRouteData(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::Vector<const vsm::route::LinkInfo *>> linkList = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<const vsm::route::RGServiceLink *>> rgServiceLinkList = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<const vsm::route::LonLat *>> vertexList = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::GasStationInfo>>> gasStationList = 0,
    uint8_t routeType = 0,
    int32_t tvasId = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::PositionInfo>>> mainRoadList = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::PositionInfo>>> positionList = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::AccidentInfo>>> accidentInfoList = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<vsm::route::EVStationInfo>>> evStationList = 0,
...
inline ::flatbuffers::Offset<RouteData> CreateRouteDataDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<vsm::route::LinkInfo> *linkList = nullptr,
    const std::vector<vsm::route::RGServiceLink> *rgServiceLinkList = nullptr,
    const std::vector<vsm::route::LonLat> *vertexList = nullptr,
    const std::vector<::flatbuffers::Offset<vsm::route::GasStationInfo>> *gasStationList = nullptr,
    uint8_t routeType = 0,
    int32_t tvasId = 0,
    const std::vector<::flatbuffers::Offset<vsm::route::PositionInfo>> *mainRoadList = nullptr,
    const std::vector<::flatbuffers::Offset<vsm::route::PositionInfo>> *positionList = nullptr,
    const std::vector<::flatbuffers::Offset<vsm::route::AccidentInfo>> *accidentInfoList = nullptr,
    const std::vector<::flatbuffers::Offset<vsm::route::EVStationInfo>> *evStationList = nullptr,
    int32_t oppositeSideVertexIndex = 0) {
  auto linkList__ = linkList ? _fbb.CreateVectorOfStructs<vsm::route::LinkInfo>(*linkList) : 0;
  auto rgServiceLinkList__ = rgServiceLinkList ? _fbb.CreateVectorOfStructs<vsm::route::RGServiceLink>(*rgServiceLinkList) : 0;
  auto vertexList__ = vertexList ? _fbb.CreateVectorOfStructs<vsm::route::LonLat>(*vertexList) : 0;
  auto gasStationList__ = gasStationList ? _fbb.CreateVector<::flatbuffers::Offset<vsm::route::GasStationInfo>>(*gasStationList) : 0;
  auto mainRoadList__ = mainRoadList ? _fbb.CreateVector<::flatbuffers::Offset<vsm::route::PositionInfo>>(*mainRoadList) : 0;
  auto positionList__ = positionList ? _fbb.CreateVector<::flatbuffers::Offset<vsm::route::PositionInfo>>(*positionList) : 0;
  auto accidentInfoList__ = accidentInfoList ? _fbb.CreateVector<::flatbuffers::Offset<vsm::route::AccidentInfo>>(*accidentInfoList) : 0;
  auto evStationList__ = evStationList ? _fbb.CreateVector<::flatbuffers::Offset<vsm::route::EVStationInfo>>(*evStationList) : 0;
